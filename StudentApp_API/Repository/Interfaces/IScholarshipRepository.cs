...
namespace StudentApp_API.Repository.Interfaces
{
    ...
    {
        Task<ServiceResponse<ScholarshipQuestionsResponse>> AssignScholarshipAsync(AssignScholarshipRequest request);
        ...
        Task<ServiceResponse<ScholarshipViewKeyQuestionsResponse>> ViewKeyByStudentScholarship(GetScholarshipQuestionRequest request);
