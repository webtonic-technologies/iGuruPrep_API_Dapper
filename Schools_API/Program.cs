...
builder.Services.AddTransient<IReportedQuestionRepository, ReportedQuestionRepository>();
builder.Services.AddTransient<IReportedQuestionsServices, ReportedQuestionsServices>();
