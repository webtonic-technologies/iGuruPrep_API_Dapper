namespace Schools_API.Models
{
    public class QuestionDTO
    {
        ...
        public QuestionSubjectMapping? QuestionSubjectMapping { get; set; }
        public AnswerMultipleChoiceCategory? AnswerMultipleChoiceCategory { get; set; }
        public Answersingleanswercategory? Answersingleanswercategory { get; set; }
